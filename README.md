...
**“Using a Wald model to study time perception in intervals with varying proportions of cognitively demanding and idle phases”** (currently under revision).

It also includes the dataset from the **Choose-and-Wait Interval Reproduction (CWIR)** task analysed in the study.
